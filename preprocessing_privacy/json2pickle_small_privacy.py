...
dir_list = ["../sampled_data_small/"]
output_dir = "../input_files_small_privacy/"
...
for directory_name in dir_list:
    ...
    for data_name in data_names:
        ...
        train_data_prefix = data_name  + "_small_train_queries"
        valid_data_prefix = data_name  + "_small_valid_queries"
        test_data_prefix = data_name  + "_small_test_queries"

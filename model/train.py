...
if __name__ == "__main__":
    ...
    if args.typed:
        ...
        if args.quantile:
            for i in range(len(all_typed_values)):
                positional_encoder_log = EncoderType(output_size=300, train_values=train_typed_values[i],
                                                     all_values=all_typed_values[i], scaler="quantile")
    ...
    train_log_dir = '../logs/gradient_tape/' + current_time + "_" + args.model + "_" + data_name + "_" + args.numeral_encoder + '_privacy'
    test_log_dir = '../logs/gradient_tape/' + current_time + "_" + args.model + "_" + data_name + "_" + args.numeral_encoder  + '_privacy'

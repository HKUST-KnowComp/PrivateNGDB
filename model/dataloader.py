...
class TestDataset(Dataset):
    def __init__(self, nentity, nrelation, query_answers_dict, baseline=False, value_vocab=None, nattribute=0):
        ...
        self.test_private_answer_list = []
        self.test_public_answer_list = []
        ...
        for query, answer_list in query_answers_dict.items():
            ...
            single_query_answer_list = []
            for ans in answer_list["test_private_answers"]:
                if isinstance(ans, str):
                    single_query_answer_list.append(int(ans))
                elif baseline:
                    single_query_answer_list.append(value_vocab[(ans[0], ans[1])] + nentity)
                    ...
                    single_query_answer_list.append((ans[0], ans[1]))
            self.test_private_answer_list.append(single_query_answer_list)

            single_query_answer_list = []
            for ans in answer_list["test_public_answers"]:
                if isinstance(ans, str):
                    single_query_answer_list.append(int(ans))
                elif baseline:
                    single_query_answer_list.append(value_vocab[(ans[0], ans[1])] + nentity)
                    ...
                    single_query_answer_list.append((ans[0], ans[1]))
            self.test_public_answer_list.append(single_query_answer_list)
    ...
    def __getitem__(self, idx):
        ...
        test_private_answer_list = self.test_private_answer_list[idx]
        test_public_answer_list = self.test_public_answer_list[idx]
        unified_id_list = self.unified_id_list[idx]

        return ids_in_query, unified_id_list, train_answer_list, valid_answer_list, test_answer_list, \
            self.query_type, test_private_answer_list, test_public_answer_list
    ...
    def collate_fn(data):
        ...
        test_private_answer_list = [_[6] for _ in data]
        test_public_answer_list = [_[7] for _ in data]
        ...
        return batched_query, unified_ids, train_answers, valid_answers, test_answers, \
            test_private_answer_list, test_public_answer_list
...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return ids_in_query, unified_id_list, positive_sample, self.query_type, answer_list
    ...
    def collate_fn(data):
        ...
        batched_query = Instantiation(ids_in_query_matrix).instantiate(query_type[0])
        positive_sample_list = [_[4] for _ in data]

        return batched_query, unified_ids, positive_sample, positive_sample_list
